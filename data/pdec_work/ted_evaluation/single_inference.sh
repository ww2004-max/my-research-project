...
$DIR \
-s $src -t $tgt \
--langs "en,ar,he,ru,ko,it,ja,zh,es,nl,vi,tr,pl,ro,fa,hr,cs,de" \
--lang-pairs "ar-en,en-ar,he-en,en-he,ru-en,en-ru,ko-en,en-ko,it-en,en-it,ja-en,en-ja,zh-en,en-zh,es-en,en-es,nl-en,en-nl,vi-en,en-vi,tr-en,en-tr,pl-en,en-pl,ro-en,en-ro,fa-en,en-fa,hr-en,en-hr,cs-en,en-cs,de-en,en-de" \
