...
from .transformer_zero import TransformerModelZero
...
@register_model("bart_zero")
class BARTModelZero(TransformerModelZero):
    ...
    @staticmethod
    def add_args(parser):
        super(BARTModelZero, BARTModelZero).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
    ...
    def forward(
        ...
        **kwargs,
        ...
        extra["src_direction"] = src_direction
        extra["tgt_direction"] = tgt_direction
        extra["prev_output_tokens"] = prev_output_tokens
        extra["language_num"] = encoder_out["language_num"]
        eos: int = self.eos
        if classification_head_name is not None:
...
@register_model_architecture("bart_zero", "bart_large_zero")
...
@register_model_architecture("bart_zero", "mbart_large_zero")
