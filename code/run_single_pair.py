...
cmd = [
    ...
    os.path.join(ROOT_PATH, "fairseq", "fairseq_cli", "generate.py"),
    DATA_BIN,
    "--user-dir", os.path.join(WORK_PATH, "models", "PhasedDecoder"),
    "-s", SRC, "-t", TGT,
    "--langs", "en,de,es,it",
    "--lang-pairs", "en-de,en-es,en-it,de-en,de-es,de-it,es-en,es-de,es-it,it-en,it-de,it-es",
